...
export const AI_PROVIDERS: AIProviderOption[] = [
    ...
    models: [
      {
        ...
        providerId: 'openai',
        providerName: 'OpenAI',
        badge: 'Next-Gen Ultra Fast',
        description: 'Next-generation ultra-compact, low-latency reasoning and conversational intelligence model.',
  ...
  },
  {
    ...
    badge: '100% Private',
    description: 'Offline local models running on your device hardware with zero data transfer',
    iconColor: '#a855f7',
    models: [
      {
        id: 'llama3.2:3b',
        ...
        badge: 'On-Device Edge',
        description: 'Lightweight on-device model for 100% offline edge execution.',
        contextWindow: '8k Tokens',
        speed: 'Fast',
        iconColor: '#a855f7',
      },
      {
        ...
        providerId: 'ollama',
        providerName: 'Local Ollama',
        badge: 'Offline General',
        description: 'Standard local model for private, air-gapped notes and chat synthesis.',
        contextWindow: '8k Tokens',
        speed: 'Fast',
        iconColor: '#c084fc',
      },
      {
        ...
        providerName: 'Local Ollama',
        badge: 'Local Coding',
        description: 'Specialized local code assistance with complete privacy.',
        contextWindow: '32k Tokens',
        speed: 'Fast',
        iconColor: '#e879f9',
      },
